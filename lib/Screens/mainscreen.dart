...
class _MainScreenState extends State<MainScreen> {
   ...
   getProductsFromFirestore() async{
     ...
     var snapshot = await FirebaseFirestore.instance.collection("home").get();
     snapshot.docs.forEach((doc ) {
       proList.add(Pro(
         name:doc['Product_Name'].toString(),
         category: doc['Product_Category'].toString(),
         price: doc['Product_Amount'].toString(),
         image:doc['Product_Image'].toString(),
       ));
       debugPrint(doc["Product_Name"]);
       //debugPrint("$image")
     });
   }
          ...
          SliverGrid(
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                return Padding(
                  ...
                  child:GestureDetector(
                    onTap:(){
                      print(proList[index].name+" tapped");
                    },
                    child:Card (
                      elevation:3,
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image:NetworkImage(proList[index].image),
                                )
                                ),
                               // child: Image.asset(proList[index].image),
                                    ...
                                    children:[
                                      ...
                                      Padding(
                                        ...
                                        child: Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            (proList[index].price).toString()+"₹ Mo",
                                            style: TextStyle(
                                              fontSize: 11.sp,
                                              color:Colors.grey[700],
